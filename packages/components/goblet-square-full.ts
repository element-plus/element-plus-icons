...
const GobletSquareFull = function (props: any) {
  return h(Icon, props, {
    default: () => [
      h(
        'path',
...
GobletSquareFull.displayName = 'ElIconGobletSquareFull'

export default GobletSquareFull
